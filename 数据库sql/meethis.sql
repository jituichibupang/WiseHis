...
-- ----------------------------
-- Table structure for meethis_admin
-- ----------------------------
DROP TABLE IF EXISTS `meethis_admin`;
CREATE TABLE `meethis_admin`  (
...
INSERT INTO `meethis_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', NULL, 1, 1, 1, 1735302901541, 0, 1734786380484);

-- ----------------------------
-- Table structure for meethis_fav
-- ----------------------------
DROP TABLE IF EXISTS `meethis_fav`;
CREATE TABLE `meethis_fav`  (
...
-- ----------------------------
-- Table structure for meethis_meet
-- ----------------------------
DROP TABLE IF EXISTS `meethis_meet`;
CREATE TABLE `meethis_meet`  (
...
-- ----------------------------
-- Table structure for meethis_meet_join
-- ----------------------------
DROP TABLE IF EXISTS `meethis_meet_join`;
CREATE TABLE `meethis_meet_join`  (
...
-- ----------------------------
-- Table structure for meethis_news
-- ----------------------------
DROP TABLE IF EXISTS `meethis_news`;
CREATE TABLE `meethis_news`  (
...
-- ----------------------------
-- Table structure for meethis_setup
-- ----------------------------
DROP TABLE IF EXISTS `meethis_setup`;
CREATE TABLE `meethis_setup`  (
...
-- ----------------------------
-- Table structure for meethis_user
-- ----------------------------
DROP TABLE IF EXISTS `meethis_user`;
CREATE TABLE `meethis_user`  (
